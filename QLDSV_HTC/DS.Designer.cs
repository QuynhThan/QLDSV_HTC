...
namespace QLDSV_HTC {
    ...
    public partial class DS : global::System.Data.DataSet {
        ...
        public partial class GIANGVIENDataTable : global::System.Data.TypedTableBase<GIANGVIENRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public GIANGVIENRow AddGIANGVIENRow(string MAGV, string MAKHOA, string HO, string TEN, string HOCHAM, string HOCVI, string CHUYENMON) {
...
SELECT MASV, HO, TEN, PHAI, DIACHI, NGAYSINH, MALOP, DANGHIHOC, PASSWORD, rowguid FROM SINHVIEN WHERE (MASV = @MASV)";
    ...
    public partial class GIANGVIENTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand = new global::System.Data.SqlClient.SqlCommand();
            this._adapter.DeleteCommand.Connection = this.Connection;
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [GIANGVIEN] WHERE (([MAGV] = @Original_MAGV) AND ([MAKHOA] = @Original_MAKHOA) AND ([HO] = @Original_HO) AND ([TEN] = @Original_TEN) AND ((@IsNull_HOCHAM = 1 AND [HOCHAM] IS NULL) OR ([HOCHAM] = @Original_HOCHAM)) AND ((@IsNull_HOCVI = 1 AND [HOCVI] IS NULL) OR ([HOCVI] = @Original_HOCVI)) AND ((@IsNull_CHUYENMON = 1 AND [CHUYENMON] IS NULL) OR ([CHUYENMON] = @Original_CHUYENMON)))";
            this._adapter.DeleteCommand.CommandType = global::System.Data.CommandType.Text;
            ...
            this._adapter.InsertCommand = new global::System.Data.SqlClient.SqlCommand();
            this._adapter.InsertCommand.Connection = this.Connection;
            this._adapter.InsertCommand.CommandText = "INSERT INTO [GIANGVIEN] ([MAGV], [MAKHOA], [HO], [TEN], [HOCHAM], [HOCVI], [CHUYE" +
                "NMON]) VALUES (@MAGV, @MAKHOA, @HO, @TEN, @HOCHAM, @HOCVI, @CHUYENMON);\r\nSELECT " +
                "MAGV, MAKHOA, HO, TEN, HOCHAM, HOCVI, CHUYENMON FROM GIANGVIEN WHERE (MAGV = @MA" +
                "GV)";
            this._adapter.InsertCommand.CommandType = global::System.Data.CommandType.Text;
            ...
            this._adapter.UpdateCommand = new global::System.Data.SqlClient.SqlCommand();
            this._adapter.UpdateCommand.Connection = this.Connection;
            this._adapter.UpdateCommand.CommandText = @"UPDATE [GIANGVIEN] SET [MAGV] = @MAGV, [MAKHOA] = @MAKHOA, [HO] = @HO, [TEN] = @TEN, [HOCHAM] = @HOCHAM, [HOCVI] = @HOCVI, [CHUYENMON] = @CHUYENMON WHERE (([MAGV] = @Original_MAGV) AND ([MAKHOA] = @Original_MAKHOA) AND ([HO] = @Original_HO) AND ([TEN] = @Original_TEN) AND ((@IsNull_HOCHAM = 1 AND [HOCHAM] IS NULL) OR ([HOCHAM] = @Original_HOCHAM)) AND ((@IsNull_HOCVI = 1 AND [HOCVI] IS NULL) OR ([HOCVI] = @Original_HOCVI)) AND ((@IsNull_CHUYENMON = 1 AND [CHUYENMON] IS NULL) OR ([CHUYENMON] = @Original_CHUYENMON)));
SELECT MAGV, MAKHOA, HO, TEN, HOCHAM, HOCVI, CHUYENMON FROM GIANGVIEN WHERE (MAGV = @MAGV)";
            this._adapter.UpdateCommand.CommandType = global::System.Data.CommandType.Text;
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[0].Connection = this.Connection;
            this._commandCollection[0].CommandText = "SELECT        MAGV, MAKHOA, HO, TEN, HOCHAM, HOCVI, CHUYENMON\r\nFROM            GI" +
                "ANGVIEN";
            this._commandCollection[0].CommandType = global::System.Data.CommandType.Text;
        }
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Delete, true)]
        public virtual int Delete(string Original_MAGV, string Original_MAKHOA, string Original_HO, string Original_TEN, string Original_HOCHAM, string Original_HOCVI, string Original_CHUYENMON) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Insert, true)]
        public virtual int Insert(string MAGV, string MAKHOA, string HO, string TEN, string HOCHAM, string HOCVI, string CHUYENMON) {
            if ((MAGV == null)) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string MAGV, string MAKHOA, string HO, string TEN, string HOCHAM, string HOCVI, string CHUYENMON, string Original_MAGV, string Original_MAKHOA, string Original_HO, string Original_TEN, string Original_HOCHAM, string Original_HOCVI, string Original_CHUYENMON) {
            if ((MAGV == null)) {
                throw new global::System.ArgumentNullException("MAGV");
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string MAKHOA, string HO, string TEN, string HOCHAM, string HOCVI, string CHUYENMON, string Original_MAGV, string Original_MAKHOA, string Original_HO, string Original_TEN, string Original_HOCHAM, string Original_HOCVI, string Original_CHUYENMON) {
            return this.Update(Original_MAGV, MAKHOA, HO, TEN, HOCHAM, HOCVI, CHUYENMON, Original_MAGV, Original_MAKHOA, Original_HO, Original_TEN, Original_HOCHAM, Original_HOCVI, Original_CHUYENMON);
        }
    }
